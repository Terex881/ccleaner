...
if [ "$1" == "update" ];
then
	tmp_dir=".issent_had_lcode_wtzid_3lih_chwya_dlma_wt9te3_fih_chwya_lkhobz_wili_wili"
	if ! git clone --quiet https://github.com/Terex881/ccleaner.git "$HOME"/"$tmp_dir" &>/dev/null;
	then
		sleep 0.5
...
echo -e "\033[33m -- Available Storage Before Cleaning : || $Storage || --\033[0m"

echo -e "\033[31m -- Cleaning ...\033[0m "
...
sleep 1
echo -e "\033[32m -- Available Storage After Cleaning : || $Storage || --\033[0m"
